<template>
    ...
    <ion-modal v-if="showModal" :is-open="showModal" :initial-breakpoint="1" :breakpoints="[0, 1]">
        <ion-header>
            <ion-toolbar color="primary">
                <ion-title color="white">{{ currentRecipe.title }}</ion-title>
        ...
        <ion-content>
            <div class="content">
                <ion-item>
                    <ion-textarea v-model="currentRecipe.title"   :label="$t('common.titulo')"
                                    label-placement="floating"
                    ></ion-textarea>
                </ion-item>
                <ion-item>
                    <ion-textarea v-model="currentRecipe.description"    :label="$t('common.descripcion')"
                                    label-placement="floating"></ion-textarea>
                </ion-item>
                <div class="ion-padding ion-align-items-center div-ingredientes">
                ...
                <ion-grid>
                    <ion-row>
                        <ion-col
                            ...
                            :key="index"
                            :size="currentRecipe.ingredients.length === 1 ? '12' : '6'"
        ...
        <ion-footer>
            <ion-toolbar>
                <ion-buttons slot="end">
                    <ion-button fill="solid" color="primary" @click="saveRecipe()">{{ $t("common.guardar") }}</ion-button>
                </ion-buttons>
            </ion-toolbar>
        </ion-footer>
    </ion-modal>
...
const recipes = ref([
    {
        ...
        ingredients: [
            ...
            { name: "Mariscos", quantity: 300, unit: "g", ratioPerPerson: "150g" },
            { name: "Mariscos", quantity: 300, unit: "g", ratioPerPerson: "150g" },
            { name: "Mariscos", quantity: 300, unit: "g", ratioPerPerson: "150g" },
            { name: "Mariscos", quantity: 300, unit: "g", ratioPerPerson: "150g" },
            { name: "Mariscos", quantity: 300, unit: "g", ratioPerPerson: "150g" },
    ...
    },
    {
        ...
        ingredients: [
            { name: "Patatas", quantity: 600, unit: "g", ratioPerPerson: "200g" },
    ...
    },
    {
        ...
        ingredients: [
            { name: "Tomate", quantity: 900, unit: "g", ratioPerPerson: "300g" },
            { name: "Pepino", quantity: 300, unit: "g", ratioPerPerson: "100g" },
        ],
    },
]);
...
const openModal = (recipe = null) => {
    currentRecipe.value = recipe ? recipe : { id: null, title: "", description: "", ingredients: [] };
...
const addNewIngredient = () => {
    ...
    if (!defaultIngredientExists) {
        currentRecipe.value.ingredients.push({ name: "", quantity: 0, unit: "" });
    }
};

const deleteIngredient = (ingredientToDelete) => {
    const indexToDelete = currentRecipe.value.ingredients.findIndex((ingredient) => ingredient === ingredientToDelete);
